...
describe('test/client.test.js', () => {
  ...
  it('should client send message ok', done => {
    const msg = {
      name: 'midway',
    };
  ...
  it('should client send message and receive callback ok', done => {
    const msg = {
      name: 'midway',
    };
  ...
  it('should client send message and receive timeout ok', done => {
    const msg = {
      name: 'midway',
    };
  ...
  it('should emit close in the same tick', done => {
